/**
 * Defines the guided tour steps for the Quipucords application.
 * This module contains the configuration for each step of the guided tour,
 * including content, positioning, and element selectors for highlighting.
 * It also provides a marker component for tour elements.
 *
 * @module tourSteps
 */
...
export { guidedTourSteps as default, guidedTourSteps, type GuidedTourStep };
