/**
 * Creates a spotlight effect that highlights a specific element on the page.
 * It renders a full-screen overlay with a transparent "hole" where the target element is located.
 * The component automatically updates when the element's position changes due to scrolling or resizing.
 *
 * @module spotlight
 */
...
const GuidedTourSpotlight: React.FC<GuidedTourSpotlightProps> = ({ selector, resizeSelector }) => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="guided-tour__spotlight" style={{ clipPath }} />
...
export { GuidedTourSpotlight as default, GuidedTourSpotlight, type GuidedTourSpotlightProps, type BoundingClientRect };
