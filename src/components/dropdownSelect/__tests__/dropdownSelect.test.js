...
import { DropdownSelect, formatOptions, formatPfProps, SelectDirection, SelectPosition } from '../dropdownSelect';
...
describe('Select Component', () => {
  ...
  it('shoudl apply patternfly select props based on wrapper props', () => {
    const props = {};

    expect(formatPfProps(props)).toMatchSnapshot('patternfly props, disabled');

    props.options = [];
    expect(formatPfProps(props)).toMatchSnapshot('patternfly props, no options, disabled');

    props.options = ['lorem', 'ipsum'];
    props.isDisabled = true;
    expect(formatPfProps(props)).toMatchSnapshot('patternfly props, options, disabled');

    props.placeholder = 'dolor sit';
    props.isDisabled = false;
    expect(formatPfProps(props)).toMatchSnapshot('patternfly props, placeholder');
  });
